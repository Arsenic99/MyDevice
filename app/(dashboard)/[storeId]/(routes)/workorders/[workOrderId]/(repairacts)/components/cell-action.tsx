...
import { RepairActColumn } from "./columns";
import { phrase } from "@/lib/lang";

interface CellActionProps {
    data: RepairActColumn;
}
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onConfirm = async () => {
        try {
            setLoading(true);
            await axios.delete(`/api/${params.storeId}/repairacts/${data.id}`);
            ...
            toast.error('Make sure you removed all categories using this RepairAct first.');
        } finally {
            setOpen(false);
            setLoading(false);
        }
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={() => router.push(`/${params.storeId}/repairacts/${data.id}`)}
                    >
